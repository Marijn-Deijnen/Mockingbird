...
class SettingsPanel(QGroupBox):
    ...
    def _setup_ui(self, cfg: dict):
        ...
        # --- Denoiser ---
        self._denoiser_toggle = ToggleSwitch()
        layout.addRow("Use Denoiser", self._denoiser_toggle)
        ...
        self._denoiser_toggle.blockSignals(True)
        ...
        self._denoiser_toggle.setChecked(cfg.get("use_denoiser", False))
        ...
        self._denoiser_toggle.blockSignals(False)
        ...
        self._denoiser_toggle.toggled.connect(self._emit)
    ...
    def values(self) -> dict:
        return {
            ...
            "use_denoiser": self._denoiser_toggle.isChecked(),
        }
    ...
    def set_values(self, cfg_value: float, inference_timesteps: int, use_denoiser: bool) -> None:
        ...
        self._denoiser_toggle.setChecked(use_denoiser)
